...
class ConfigurationFactory extends Factory
{
    ...
    {
        $paths = [ "allow_countries", "optional_zip_countries", "state_country", "store_phone_number", "store_hours_operation", "store_country", "store_zip_code", "store_street_address", "store_address_line2", "store_image", "store_language" ];
