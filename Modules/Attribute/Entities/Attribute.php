...
class Attribute extends Model
{
    ...
    protected $fillable = ['slug', 'name', 'type', 'position', 'is_required', 'is_unique', 'validation', 'is_filterable', 'is_configurable', 'is_visible_on_front', 'is_user_defined', 'use_in_flat'];
